...
+ [Instalação do Java](https://www.oracle.com/java/technologies/javaee-8-sdk-downloads.html) - Pacote necessário para desenvolvimento de aplicações para web com Java
+ [AWS - Amazon](https://aws.amazon.com/pt/builders-library/challenges-with-distributed-systems/) - Desafios com Sistemas Distribuídos.

## Materiais de apoio (Vídeos)
+ [Redes centralizadas, descentralizadas e distribuídas](https://youtu.be/uCWPCJEXwPs)
+ [Sistemas Distribuídos com PHP](https://youtu.be/exf0HPoV1MA)
